<?php
ob_start();
$actor = $requeteUpdateRealisateur->fetch(); ?>

<form enctype="multipart/form-data" action="index.php?action=updateRealisateur&id=<?= $actor["id_director"]?>" method="post">
        
        <h3>update director</h3>
        
        
        <h2> <?= $actor["directorComplete"] ?> </h2>
